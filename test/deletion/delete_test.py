...
# user prompt: "Delete all experiments that are marked as invalid in the database stored in this directory: data/db/sample_data.db."
# table: "Experiment". filters: {"is_valid": "N"}. This will delete all records from the Experiment table where is_valid is 'N' in the database in this directory: data/db/sample_data.db."
# user prompt: "Delete all experiments that took place on August 3rd, 2023, in this directory: data/db/sample_data.db.""
# table: "Experiment". filters: {"date": "20230803"}. This will delete all records from the Experiment table where date is '2023-08-03', in the database in this directory: data/db/sample_data.db."
#------------------------------------------------------------------------
...
# user prompt: "Delete all time-lapse capture settings, in the database in this directory: data/sample_data.db."
...
# user prompt: "Delete all masks for invalid experiments for yeast Rfa1 protein that are untreated, in the database in this directory: data/sample_data.db."
...
# user prompt: "Delete all records from the ImageStacks table where organism is yeast and protein is Rfa1, in the database in this directory: data/sample_data.db."
...
# user prompt: "Delete all records from the User table, in the database in this directory: data/sample_data.db."
# table: "User". filters: {}. This will delete all records from the User table.
# ---------------------------------------------------------------------------

# ---------------------------------------------------------------------------
# 8. delete records with filters that match no records.
# user prompt: "Delete all capture settings with exposure time of 1000, in the database in this directory: data/sample_data.db."
