...
# user prompts: "Delete all users with empty email addresses."
...
# user prompt: " Delete all invalid tracking files from August 3rd, 2023."
...
# user prompt: "Delete all yeast Rfa1 raw files that are untreated marked as invalid."
...
# user prompt: "Delete all time-lapse capture settings."
...
# user prompt: "Delete all masks for invalid experiments for yeast Rfa1 protein that are untreated ."
...
# user prompt: "Delete all records from the ImageStacks table where organism is yeast and protein is Rfa1."
